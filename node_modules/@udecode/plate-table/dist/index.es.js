import { getNodeEntry, getPreviousPath, getPluginTypes, getPluginType, findNode, getBlockAbove, findNodePath, getParentNode, getAboveNode, getNode, getEdgeBlocksAbove, someNode, withoutNormalizing, removeNodes, setNodes, insertNodes, selectEditor, getStartPoint, getPluginOptions, insertElements, select, hasNode, moveSelection, getEndPoint, isRangeAcrossBlocks, isRangeInSameBlock, isElement, Hotkeys, isCollapsed, replaceNodeChildren, getPointAfter, getPointBefore, getTEditor, isExpanded, collapseSelection, unwrapNodes, isText, wrapNodeChildren, createPluginFactory, createAtomStore, usePlateEditorRef, unsetNodes, useElement, focusEditor, usePlateEditorState } from '@udecode/plate-common';
import { Path, Point, Range } from 'slate';
import { useCallback, useEffect, useMemo } from 'react';
import { resizeLengthClampStatic } from '@udecode/plate-resizable';
...
const getCellInPreviousTableRow = (editor, currentRowPath) => {
  ...
  if (!prevPath) return;
  const previousRow = getNodeEntry(editor, prevPath);
...
const insertTableColumn = (editor, {
  ...
  withoutNormalizing(editor, () => {
    ...
    tableNode.children.forEach((row, rowIndex) => {
      ...
      const isHeaderRow = header === undefined ? row.children.every(c => c.type === getPluginType(editor, ELEMENT_TH)) : header;
