import { applyDeepToNodes, defaultsDeepToNodes, queryNode, someNode, isDefined, createPluginFactory } from '@udecode/plate-common';
  ...
  editor.apply = operation => {
    ...
    if (operation.type === 'split_node') {
      ...
      if (queryNode([node, operation.path], query)) {
         ...
         * - the node has no id
         */
        if (!reuseId || id === undefined || someNode(editor, {
          match: {
            [idKey]: id
          },
          at: []
...
export { KEY_NODE_ID, createNodeIdPlugin, withNodeId };
