...
export declare function SuggestionProvider({ children, ...props }: Partial<SuggestionStoreState> & {
    children: ReactNode;
}): React.JSX.Element;
...
export declare const useSuggestionById: (id?: string | null) => TSuggestion | null;
...
export declare const useUpdateSuggestion: (id?: string | null) => (value: Partial<TSuggestion>) => void;
