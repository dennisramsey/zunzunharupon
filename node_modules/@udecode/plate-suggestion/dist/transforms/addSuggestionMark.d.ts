...
export declare const addSuggestionMark: <V extends Value = Value>(editor: Omit<import("slate").BaseEditor, "id" | "children" | "operations" | "marks" | "apply" | "getDirtyPaths" | "getFragment" | "markableVoid" | "normalizeNode" | "insertFragment" | "insertNode" | "isInline" | "isVoid"> & {
    id: any;
    children: V;
    operations: import("@udecode/plate-common").TOperation[];
    ...
    key: any;
    plugins: import("@udecode/plate-common").WithPlatePlugin<{}, V>[];
    pluginsByKey: Record<string, import("@udecode/plate-common").WithPlatePlugin<{}, V>>;
...
} & SuggestionEditorProps) => void;
//# sourceMappingURL=addSuggestionMark.d.ts.map