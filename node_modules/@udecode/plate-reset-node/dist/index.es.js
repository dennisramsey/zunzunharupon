import { isCollapsed, someNode, setElements, createPluginFactory, getStartPoint, getNode, withoutNormalizing, unsetNodes, getNodeProps, setNodes, getEndPoint, resetEditorChildren } from '@udecode/plate-common';
...
const onKeyDownResetNode = (editor, {
  ...
  if (isCollapsed(editor.selection)) {
    rules.forEach(({
      ...
      if (hotkey && isHotkey(hotkey, event) && predicate(editor) && someNode(editor, {
        match: {
          type: types
        }
      })) {
...
export { KEY_RESET_NODE, SIMULATE_BACKSPACE, createResetNodePlugin, onKeyDownResetNode };
