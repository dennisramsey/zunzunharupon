...
export declare function PlateEditable<V extends Value = Value>({ children, renderEditable, editableRef, firstChildren, ...props }: PlateEditableProps<V>): React.ReactElement<any, string | React.JSXElementConstructor<any>>;
