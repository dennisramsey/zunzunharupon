 ...
 */
export declare const pipeTransformData: <V extends Value>(plugins: Partial<import("../types/plugin/PlatePlugin").PlatePlugin<import("packages/utils/dist").AnyObject, V, import("..").PlateEditor<V>>>[], { data, dataTransfer }: PlatePluginInsertDataOptions) => string;
