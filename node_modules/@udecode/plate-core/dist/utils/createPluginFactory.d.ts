 ...
 */
export declare const createPluginFactory: <P = import("packages/utils/dist").AnyObject, V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>(defaultPlugin: PlatePlugin<NoInfer<P>, V, E>) => <OP = P, OV extends Value = V, OE extends PlateEditor<OV> = PlateEditor<OV>>(override?: Partial<PlatePlugin<NoInfer<OP>, OV, OE>> | undefined, overrideByKey?: OverrideByKey<OV, OE>) => PlatePlugin<NoInfer<OP>, OV, OE>;
