 ...
 */
export declare const pluginInjectProps: <V extends Value>(editor: PlateEditor<V>, { key, inject: { props } }: WithPlatePlugin<{}, V>, nodeProps: GetInjectPropsOptions<V>) => GetInjectPropsReturnType | undefined;
