...
import { EElement, TEditor, TElement, THistoryEditor, TRange, Value } from '@udecode/slate';
...
export type PlateEditor<V extends Value = Value> = TEditor<V> & THistoryEditor<V> & TReactEditor<V> & PlateEditorMethods<V> & {
    key: any;
