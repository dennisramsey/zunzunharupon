...
export type DOMHandler<P = PluginOptions, V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>, EV = {}> = (editor: E, plugin: WithPlatePlugin<P, V, E>) => DOMHandlerReturnType<EV>;
export interface DOMHandlers<P = PluginOptions, V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>> {
