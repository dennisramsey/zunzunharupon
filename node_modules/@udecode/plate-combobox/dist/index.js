...
const getTextFromTrigger = (editor, {
  ...
  while (true) {
    ...
    if (!start) break;
    start = plateCommon.getPointBefore(editor, start);
    const charRange = start && plateCommon.getRange(editor, start, end);
...
const createComboboxPlugin = plateCommon.createPluginFactory({
  key: KEY_COMBOBOX,
  handlers: {
