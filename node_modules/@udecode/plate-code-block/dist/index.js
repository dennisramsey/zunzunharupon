...
const useCodeBlockComboboxState = () => {
  ...
  const {
    syntaxPopularFirst
  } = plateCommon.getPluginOptions(editor, ELEMENT_CODE_BLOCK);
  React.useEffect(() => {
    var _element$lang2;
  ...
  return {
    commandItemProps: {
      onSelect: _value => {
        ...
        path && plateCommon.setNodes(editor, {
          lang: _value
        }, {
          at: path
        });
...
exports.useCodeBlockCombobox = useCodeBlockCombobox;
exports.useCodeBlockComboboxState = useCodeBlockComboboxState;
exports.useCodeBlockElementState = useCodeBlockElementState;
exports.useCodeSyntaxLeaf = useCodeSyntaxLeaf;
