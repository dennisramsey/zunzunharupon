import { createPluginFactory, createPrimitiveComponent, createStore, useElement, usePlateEditorRef, useHotkeys, focusEditor, getInjectedPlugins, pipeInsertDataQuery, getPluginOptions, setNodes, getPluginType, insertNodes, isUrl, someHtmlElement, onKeyDownToggleMark, findHtmlParentElement } from '@udecode/plate-common';
import { ELEMENT_BLOCKQUOTE } from '@udecode/plate-block-quote';
import { ELEMENT_CODE_BLOCK, ELEMENT_CODE_LINE } from '@udecode/plate-code-block';
import { ELEMENT_H1, ELEMENT_H2, ELEMENT_H3, ELEMENT_H4, ELEMENT_H5, ELEMENT_H6 } from '@udecode/plate-heading';
import { ELEMENT_LINK } from '@udecode/plate-link';
import { ELEMENT_OL, ELEMENT_UL, ELEMENT_LI, ELEMENT_LIC } from '@udecode/plate-list';
...
const remarkDefaultTextRules = {
  ...
  emphasis: {
    mark: ({
      editor
    }) => getPluginType(editor, MARK_ITALIC)
  },
  strong: {
    mark: ({
      editor
    }) => getPluginType(editor, MARK_BOLD)
  },
  inlineCode: {
    mark: ({
      editor
    }) => getPluginType(editor, MARK_CODE)
  },
  html: {
...
export { KEY_DESERIALIZE_MD, createDeserializeMdPlugin, deserializeMd, filterBreaklines, remarkDefaultElementRules, remarkDefaultTextRules, remarkPlugin, remarkTextTypes, remarkTransformElement, remarkTransformElementChildren, remarkTransformNode, remarkTransformText };
