...
export type MdastElementType = 'paragraph' | 'heading' | 'list' | 'listItem' | 'link' | 'image' | 'blockquote' | 'code' | 'thematicBreak';
export type MdastTextType = 'emphasis' | 'strong' | 'delete' | 'inlineCode' | 'html' | 'text';
