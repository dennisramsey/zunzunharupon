...
export declare const useFloatingLinkInsertState: ({ floatingOptions, }?: LinkFloatingToolbarState) => {
...
export declare const useFloatingLinkInsert: ({ editor, triggerFloatingLinkHotkeys, floating, focused, isOpen, readOnly, }: ReturnType<typeof useFloatingLinkInsertState>) => {
...
//# sourceMappingURL=useFloatingLinkInsert.d.ts.map