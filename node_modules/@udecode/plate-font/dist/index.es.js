...
const useColorDropdownMenuState = ({
  nodeType,
  closeOnSelect = true,
  colors,
  customColors
  ...
  const onToggle = useCallback((value = !open) => {
    setOpen(value);
  }, [open, setOpen]);
  ...
  const updateColorAndClose = useCallback(value => {
    updateColor(value);
...
const useColorsCustomState = ({
  ...
  const computedColors = useMemo(() => customColor ? [...customColors, {
    name: '',
    value: customColor,
    isBrightColor: false
...
const useColorsCustom = ({
  updateCustomColor,
  value,
  setValue
}) => {
  // eslint-disable-next-line react-hooks/exhaustive-deps
  const updateCustomColorDebounced = useCallback(debounce_1(updateCustomColor, 100), [updateCustomColor]);
  return {
    inputProps: {
      value,
      onChange: e => {
...
export { MARK_BG_COLOR, MARK_COLOR, MARK_FONT_FAMILY, MARK_FONT_SIZE, MARK_FONT_WEIGHT, createFontBackgroundColorPlugin, createFontColorPlugin, createFontFamilyPlugin, createFontSizePlugin, createFontWeightPlugin, useColorDropdownMenu, useColorDropdownMenuState, useColorInput, useColorsCustom, useColorsCustomState };
