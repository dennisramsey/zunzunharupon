...
import { usePlateEditorState, usePlateEditorRef, applyDeepToNodes, getPluginType, ELEMENT_DEFAULT, toggleNodeType } from '@udecode/plate-core';
import { focusEditor, findNodePath } from '@udecode/slate-react';
import { isMarkActive, toggleMark, replaceNodeChildren } from '@udecode/slate-utils';
import { isElementEmpty, queryNode, isCollapsed, removeNodes, getStartPoint, getEndPoint, select } from '@udecode/slate';
...
const useMarkToolbarButtonState = ({
  ...
  const pressed = !!(editor !== null && editor !== void 0 && editor.selection) && isMarkActive(editor, nodeType);
  return {
    pressed,
    nodeType,
    clear
...
const createPrimitiveComponent = element => {
  ...
  return ({
    ...
    return /*#__PURE__*/React.forwardRef(({
      ...
      const state = isDefined(stateProp) ? stateProp : stateHook ? stateHook(options) : undefined;
      const {
        ref: hookRef,
        props: hookProps,
        hidden
      ...
      const className = isDefined(hookProps === null || hookProps === void 0 ? void 0 : hookProps.className) || isDefined(classNameProp) ? clsx(hookProps === null || hookProps === void 0 ? void 0 : hookProps.className, classNameProp) : undefined;
...
export { Box, DEFAULT_IGNORE_CLASS, PlateElement, PlateLeaf, PortalBody, Text, composeEventHandlers, composeRefs, createNodeHOC, createNodesHOC, createNodesWithHOC, createPrimitiveComponent, createSlotComponent, defaultsDeepToNodes, getRootProps, isType, onKeyDownToggleElement, onKeyDownToggleMark, resetEditorChildren, selectEditor, useComposedRef, useMarkToolbarButton, useMarkToolbarButtonState, useOnClickOutside, usePlaceholderState, usePlateElement, usePlateLeaf, useRemoveNodeButton, useStableMemo, withProps, withProviders };
