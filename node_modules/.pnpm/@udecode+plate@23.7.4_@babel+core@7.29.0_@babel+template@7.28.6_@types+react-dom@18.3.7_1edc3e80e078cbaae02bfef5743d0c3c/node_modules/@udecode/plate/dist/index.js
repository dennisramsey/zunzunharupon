...
const useEmojiPicker = ({
  ...
  const setIsOpen = react.useCallback(isOpen => {
    dispatch({
...
function useEmojiDropdownMenuState({
  ...
  const [emojiLibrary, indexSearch] = plateCommon.useStableMemo(() => {
...
exports.useEmojiComboboxState = useEmojiComboboxState;
exports.useEmojiDropdownMenuState = useEmojiDropdownMenuState;
...
Object.keys(plateResizable).forEach(function (k) {
  if (k !== 'default' && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
    enumerable: true,
    get: function () { return plateResizable[k]; }
  });
});
