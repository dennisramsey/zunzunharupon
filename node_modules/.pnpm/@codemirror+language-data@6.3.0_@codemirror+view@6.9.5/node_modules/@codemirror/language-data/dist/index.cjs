...
const languages = [
    ...
    language.LanguageDescription.of({
        ...
        extensions: ["sass"],
        load() {
            return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@codemirror/lang-sass')); }).then(m => m.sass({ indented: true }));
        }
    }),
    language.LanguageDescription.of({
        name: "SCSS",
        extensions: ["scss"],
        load() {
            return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@codemirror/lang-sass')); }).then(m => m.sass());
        }
    }),
    language.LanguageDescription.of({
        name: "SQL",
    ...
    language.LanguageDescription.of({
        ...
        extensions: ["vue"],
        load() {
            return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@codemirror/lang-vue')); }).then(m => m.vue());
        }
    }),
    language.LanguageDescription.of({
        name: "Angular Template",
        load() {
            return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@codemirror/lang-angular')); }).then(m => m.angular());
        }
    })
];
