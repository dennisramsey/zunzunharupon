...
export interface AutoformatQueryOptions<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>> extends Omit<AutoformatCommonRule<V, E>, 'query'> {
    /**
     * `insertText` text.
     */
    text: string;
}
export interface AutoformatCommonRule<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>> {
    /**
...
export interface AutoformatBlockRule<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>> extends AutoformatCommonRule<V, E> {
    /**
     * - text: insert text.
...
export interface AutoformatMarkRule<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>> extends AutoformatCommonRule<V, E> {
    mode: 'mark';
    /**
     * Mark(s) to add.
     */
...
export interface AutoformatTextRule<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>> extends AutoformatCommonRule<V, E> {
    mode: 'text';
    match: string | string[];
    /**
     ...
     */
    format: string | string[] | ((editor: E, options: GetMatchPointsReturnType) => void);
}
export type AutoformatRule<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>> = AutoformatBlockRule<V, E> | AutoformatMarkRule<V, E> | AutoformatTextRule<V, E>;
export interface AutoformatPlugin<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>> {
    /**
