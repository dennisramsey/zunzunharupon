import { findNode, getPluginType, withoutNormalizing, getNode, insertText, unwrapNodes, moveSelection, getPlugin, getNodeString, getEditorString, getRange, getPointBefore, setSelection, createPluginFactory, removeNodes, getBlockAbove, select, withoutMergingHistory, insertNodes, isEndPoint } from '@udecode/plate-common';
...
const findMentionInput = (editor, options) => findNode(editor, {
  ...options,
  match: {
...
const removeMentionInput = (editor, path) => withoutNormalizing(editor, () => {
...
const withMention = (editor, {
  ...
  editor.insertText = text => {
    ...
    const matchesPreviousCharPattern = triggerPreviousCharPattern === null || triggerPreviousCharPattern === void 0 ? void 0 : triggerPreviousCharPattern.test(previousChar);
...
export { ELEMENT_MENTION, ELEMENT_MENTION_INPUT, createMentionPlugin, findMentionInput, getMentionOnSelectItem, isNodeMentionInput, isSelectionInMentionInput, mentionOnKeyDownHandler, moveSelectionByOffset, removeMentionInput, withMention };
