...
const useColorDropdownMenuState = ({
  ...
  const updateColor = react.useCallback(value => {
    if (editor && editor && editor.selection) {
      ...
      plateCommon.select(editor, editor.selection);
  ...
  const updateColorAndClose = react.useCallback(value => {
    updateColor(value);
...
const useColorsCustomState = ({
  ...
  const computedColors = react.useMemo(() => customColor ? [...customColors, {
    name: '',
    value: customColor,
    isBrightColor: false
...
const useColorsCustom = ({
  ...
  const updateCustomColorDebounced = react.useCallback(debounce_1(updateCustomColor, 100), [updateCustomColor]);
  return {
    inputProps: {
      value,
      onChange: e => {
...
exports.useColorDropdownMenu = useColorDropdownMenu;
exports.useColorDropdownMenuState = useColorDropdownMenuState;
exports.useColorInput = useColorInput;
exports.useColorsCustom = useColorsCustom;
exports.useColorsCustomState = useColorsCustomState;
