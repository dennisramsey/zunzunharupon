...
import { PlatePlugin, PluginOptions, WithPlatePlugin } from './plugin/PlatePlugin';
import { TEditableProps } from './slate-react/TEditableProps';
export type PlateChangeKey = 'keyEditor' | 'keySelection' | 'keyDecorate';
export type PlateStoreState<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>> = {
    /**
    ...
    decorate: {
        fn: NonNullable<TEditableProps<V>['decorate']>;
    };
    renderElement: {
        fn: NonNullable<TEditableProps<V>['renderElement']>;
    };
    renderLeaf: {
        fn: NonNullable<TEditableProps<V>['renderLeaf']>;
    };
}>;
