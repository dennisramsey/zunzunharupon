...
import { GetInjectPropsOptions, GetInjectPropsReturnType } from '../../utils/pluginInjectProps';
export interface TransformOptions<V extends Value = Value> extends GetInjectPropsOptions<V> {
    nodeValue?: any;
    value?: any;
}
...
//# sourceMappingURL=InjectProps.d.ts.map