...
export declare function PlateProviderEffects<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>({ children, ...props }: PlateProviderEffectsProps<V, E>): React.JSX.Element;
