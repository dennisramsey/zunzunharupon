...
export declare function Plate<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>({ children, editableRef, firstChildren, renderEditable, editableProps, ...props }: PlateProps<V, E>): React.JSX.Element;
