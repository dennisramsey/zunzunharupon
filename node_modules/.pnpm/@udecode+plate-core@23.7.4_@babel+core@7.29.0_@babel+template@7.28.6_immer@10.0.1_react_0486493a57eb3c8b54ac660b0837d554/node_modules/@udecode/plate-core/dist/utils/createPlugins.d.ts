 ...
 */
export declare const createPlugins: <V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>(plugins: PlatePlugin<import("packages/utils/dist").AnyObject, V, E>[], { components, overrideByKey, }?: {
    /**
...
}) => PlatePlugin<import("packages/utils/dist").AnyObject, V, E>[];
