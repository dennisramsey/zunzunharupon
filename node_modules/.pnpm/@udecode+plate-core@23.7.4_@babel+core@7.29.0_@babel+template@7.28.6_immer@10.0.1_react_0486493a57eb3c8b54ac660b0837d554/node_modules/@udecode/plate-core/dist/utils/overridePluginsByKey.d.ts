 ...
 */
export declare const overridePluginsByKey: <P = import("packages/utils/dist").AnyObject, V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>(plugin: PlatePlugin<NoInfer<P>, V, E>, overrideByKey?: OverrideByKey<V, E>, nested?: boolean) => PlatePlugin<NoInfer<P>, V, E>;
