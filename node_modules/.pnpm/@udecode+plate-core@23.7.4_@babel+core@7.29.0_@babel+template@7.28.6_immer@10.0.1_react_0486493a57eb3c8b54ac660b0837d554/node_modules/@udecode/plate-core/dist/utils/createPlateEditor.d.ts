...
} & import("packages/utils/dist").UnknownObject & Pick<import("slate-history").HistoryEditor, "history" | "undo" | "redo"> & Pick<import("slate-react").ReactEditor, "insertData" | "insertFragmentData" | "insertTextData" | "setFragmentData" | "hasRange" | "hasTarget" | "hasEditableTarget" | "hasSelectableTarget" | "isTargetInsideNonReadonlyVoid"> & import("..").PlateEditorMethods<V> & {
    key: any;
    plugins: import("../types/plugin/PlatePlugin").WithPlatePlugin<{}, V>[];
    pluginsByKey: Record<string, import("../types/plugin/PlatePlugin").WithPlatePlugin<{}, V>>;
