...
export declare const usePlateSelectors: <V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>(id?: PlateId) => GetRecord<PlateStoreState<V, E>>;
export declare const usePlateActions: <V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>(id?: PlateId) => SetRecord<PlateStoreState<V, E>>;
export declare const usePlateStates: <V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>(id?: PlateId) => UseRecord<PlateStoreState<V, E>>;
