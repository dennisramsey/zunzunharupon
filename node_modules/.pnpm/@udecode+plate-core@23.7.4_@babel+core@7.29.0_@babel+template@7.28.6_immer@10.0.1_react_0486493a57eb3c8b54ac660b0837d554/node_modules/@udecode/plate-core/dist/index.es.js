...
export { Provider as JotaiProvider, atom, useAtom, useAtomValue } from 'jotai';
...
import { queryNode, isAncestor, isStartPoint, isExpanded, getMarks, removeEditorMark, getAboveNode, withoutNormalizing, isElement, isText, normalizeEditor, createTEditor, someNode, setElements } from '@udecode/slate';
...
import { Text, Range, Node as Node$1, createEditor as createEditor$1, Element } from 'slate';
...
function ElementProvider({
  ...
  return /*#__PURE__*/React.createElement(Provider, _extends({
    ...
    scope: SCOPE_ELEMENT
  }, props), /*#__PURE__*/React.createElement(Provider, _extends({
    initialValues: [[elementStore.atom.element, element]],
    scope: scope
...
const pluginInjectProps = (editor, {
  ...
  if (!queryResult && validTypes && isElement(node) && node.type && !validTypes.includes(node.type)) {
    return;
  }
