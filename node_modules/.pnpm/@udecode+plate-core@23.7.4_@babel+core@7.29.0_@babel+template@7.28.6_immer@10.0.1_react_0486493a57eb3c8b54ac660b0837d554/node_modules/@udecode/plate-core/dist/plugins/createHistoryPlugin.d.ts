...
} & import("packages/utils/dist").UnknownObject & Pick<import("slate-history").HistoryEditor, "history" | "undo" | "redo">>(editor: E) => EE;
/**
 * @see {@link withHistory}
 */
export declare const createHistoryPlugin: <OP = import("packages/utils/dist").AnyObject, OV extends Value = Value, OE extends import("..").PlateEditor<OV> = import("..").PlateEditor<OV>>(override?: Partial<import("..").PlatePlugin<import("..").NoInfer<OP>, OV, OE>> | undefined, overrideByKey?: import("..").OverrideByKey<OV, OE>) => import("..").PlatePlugin<import("..").NoInfer<OP>, OV, OE>;
