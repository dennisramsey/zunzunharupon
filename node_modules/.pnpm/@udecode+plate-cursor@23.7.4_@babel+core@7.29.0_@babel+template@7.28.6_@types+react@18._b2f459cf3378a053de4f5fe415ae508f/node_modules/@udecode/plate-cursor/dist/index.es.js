...
import { toDOMRange, getNodeEntries, isText, toDOMNode, usePlateEditorRef, useIsomorphicLayoutEffect, usePlateSelectors } from '@udecode/plate-common';
...
const useRefreshOnResize = ({
  ...
  const refresh = useCallback((sync = false) => {
...
const useCursorOverlayPositions = ({
  ...
  const selectionRectCache = useRef(new WeakMap());
  ...
  const cursors = useMemo(() => getCursorOverlayState({
    selectionRects,
    cursors: cursorStates
