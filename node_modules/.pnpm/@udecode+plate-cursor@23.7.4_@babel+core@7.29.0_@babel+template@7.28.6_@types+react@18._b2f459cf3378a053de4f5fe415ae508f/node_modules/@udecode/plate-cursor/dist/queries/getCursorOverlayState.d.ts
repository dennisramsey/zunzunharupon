 ...
 */
export declare const getCursorOverlayState: <TCursorData extends UnknownObject = UnknownObject>({ cursors: cursorStates, selectionRects, }: Pick<CursorOverlayProps<TCursorData>, "cursors"> & {
    selectionRects: Record<string, SelectionRect[]>;
}) => CursorOverlayState<TCursorData>[];
//# sourceMappingURL=getCursorOverlayState.d.ts.map