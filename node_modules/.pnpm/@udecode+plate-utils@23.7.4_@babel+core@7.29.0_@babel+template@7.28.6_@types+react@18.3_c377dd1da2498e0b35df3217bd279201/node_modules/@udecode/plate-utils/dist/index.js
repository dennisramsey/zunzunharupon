...
var slateReact$1 = require('slate-react');
...
const createSlotComponent = element =>
/*#__PURE__*/
...
const usePlateElement = props => {
  ...
  return {
    ...
    props: {
      ...
      ...rootProps,
      ...nodeProps,
      ...(elementToAttributes === null || elementToAttributes === void 0 ? void 0 : elementToAttributes(element)),
      className: clsx(props.className, nodeProps === null || nodeProps === void 0 ? void 0 : nodeProps.className)
    }
  };
};
 ...
 */
const PlateElement = /*#__PURE__*/React.forwardRef((props, ref) => {
  const {
    ref: rootRef,
    props: rootProps
  } = usePlateElement({
  ...
  return /*#__PURE__*/React.createElement(Box, _extends({}, rootProps, {
    ref: rootRef
  }));
});
PlateElement.displayName = 'PlateElement';

const usePlateLeaf = props => {
  const {
    editor,
    attributes,
    nodeProps,
  ...
  return {
    ...
    props: {
      ...
      ...rootProps,
      ...nodeProps,
      ...(leafToAttributes === null || leafToAttributes === void 0 ? void 0 : leafToAttributes(leaf)),
      className: clsx(props.className, nodeProps === null || nodeProps === void 0 ? void 0 : nodeProps.className)
    }
  };
};
 ...
 */
const PlateLeaf = /*#__PURE__*/React.forwardRef((props, ref) => {
  const {
    ref: rootRef,
    props: rootProps
  } = usePlateLeaf({
  ...
  return /*#__PURE__*/React.createElement(Text, _extends({}, rootProps, {
    ref: rootRef
  }));
});
...
const PortalBody = ({
  ...
  if (!container) return /*#__PURE__*/React.createElement(React.Fragment, null, children);
  return /*#__PURE__*/ReactDOM.createPortal(children, element || document.body);
};
...
const createNodeHOC = HOC => (Component, props) => function hoc(childrenProps) {
  return /*#__PURE__*/React.createElement(HOC, _extends({}, childrenProps, props), /*#__PURE__*/React.createElement(Component, childrenProps));
};
...
const createHOC = withHOC => {
  return (components, options) => {
    ...
    optionsList.forEach(({
      ...
      _keys.forEach(_key => {
        optionsByKey[_key] = merge_1(optionsByKey[_key], opt);
      });
    });
...
const useMarkToolbarButtonState = ({
  nodeType,
  clear
}) => {
  const editor = plateCore.usePlateEditorState();
  const pressed = !!(editor !== null && editor !== void 0 && editor.selection) && slateUtils.isMarkActive(editor, nodeType);
  return {
    pressed,
    nodeType,
    clear
  ...
  return {
    props: {
      ...
      onClick: e => {
        e.preventDefault();
        e.stopPropagation();
        slateUtils.toggleMark(editor, {
          key: state.nodeType,
          clear: state.clear
        });
        slateReact.focusEditor(editor);
      }
    }
  };
};
...
const useOnClickOutside = (callback, {
  ...
  const ref = React.useCallback(el => setRefsState(prevState => [...prevState, {
    current: el
  }]), []);
  React.useEffect(() => {
    if (!(refsOpt !== null && refsOpt !== void 0 && refsOpt.length) && refsState.length === 0) return;
    const getEls = () => {
      const els = [];
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
  [refsState, ignoreClass, excludeScrollbar, disabled, detectIFrame,
  // eslint-disable-next-line react-hooks/exhaustive-deps
  JSON.stringify(eventTypes)]);
  return ref;
};

const usePlaceholderState = ({
  hideOnBlur = true,
  query,
  element
}) => {
  const focused = slateReact$1.useFocused();
  const selected = slateReact$1.useSelected();
  const editor = plateCore.usePlateEditorState();
  const isEmptyBlock = slate.isElementEmpty(editor, element);
  const enabled = isEmptyBlock && (!query || slate.queryNode([element, slateReact.findNodePath(editor, element)], query)) && (!hideOnBlur || slate.isCollapsed(editor.selection) && hideOnBlur && focused && selected);
  return {
    enabled
  };
};

const useRemoveNodeButton = ({
  element
}) => {
  const editor = plateCore.usePlateEditorRef();
  return {
    props: {
      onClick: () => {
        const path = slateReact.findNodePath(editor, element);
        slate.removeNodes(editor, {
          at: path
        });
        slateReact.focusEditor(editor, editor.selection);
      }
    }
  };
};
...
const createPrimitiveComponent = element => {
  ...
  return ({
    ...
    return /*#__PURE__*/React.forwardRef(({
      ...
      var _props$setProps, _props$setProps2;
      const state = utils.isDefined(stateProp) ? stateProp : stateHook ? stateHook(options) : undefined;
      const {
        ref: hookRef,
        props: hookProps,
        hidden
      ...
      const className = utils.isDefined(hookProps === null || hookProps === void 0 ? void 0 : hookProps.className) || utils.isDefined(classNameProp) ? clsx(hookProps === null || hookProps === void 0 ? void 0 : hookProps.className, classNameProp) : undefined;
      const style = hookProps !== null && hookProps !== void 0 && hookProps.style || props.style ? {
        ...(hookProps === null || hookProps === void 0 ? void 0 : hookProps.style),
        ...props.style
      } : undefined;
      ...
      return /*#__PURE__*/React.createElement(Comp, _extends({
        ...
        className: className,
        style: style
      }, props, (_props$setProps = (_props$setProps2 = props.setProps) === null || _props$setProps2 === void 0 ? void 0 : _props$setProps2.call(props, hookProps !== null && hookProps !== void 0 ? hookProps : {})) !== null && _props$setProps !== void 0 ? _props$setProps : {}));
    });
  };
};
 ...
 * HOC adding props.
 */
const withProps = (Component, props) => function component(_props) {
...
const onKeyDownToggleElement = (editor, {
  ...
  const defaultType = plateCore.getPluginType(editor, plateCore.ELEMENT_DEFAULT);
  if (!hotkey) return;
...
const isType = (editor, node, key) => {
  ...
  const types = [];
  keys.forEach(_key => types.push(plateCore.getPluginType(editor, _key)));
...
const resetEditorChildren = (editor, options) => {
  slateUtils.replaceNodeChildren(editor, {
    at: [],
...
const selectEditor = (editor, {
  ...
  let location = at;
  if (edge === 'start') {
    location = slate.getStartPoint(editor, []);
  }
  if (edge === 'end') {
    location = slate.getEndPoint(editor, []);
  }
  if (location) {
    slate.select(editor, location);
  }
};

exports.Box = Box;
exports.DEFAULT_IGNORE_CLASS = DEFAULT_IGNORE_CLASS;
exports.PlateElement = PlateElement;
exports.PlateLeaf = PlateLeaf;
...
exports.createPrimitiveComponent = createPrimitiveComponent;
exports.createSlotComponent = createSlotComponent;
...
exports.resetEditorChildren = resetEditorChildren;
exports.selectEditor = selectEditor;
exports.useComposedRef = useComposedRef;
exports.useMarkToolbarButton = useMarkToolbarButton;
exports.useMarkToolbarButtonState = useMarkToolbarButtonState;
exports.useOnClickOutside = useOnClickOutside;
exports.usePlaceholderState = usePlaceholderState;
exports.usePlateElement = usePlateElement;
exports.usePlateLeaf = usePlateLeaf;
exports.useRemoveNodeButton = useRemoveNodeButton;
