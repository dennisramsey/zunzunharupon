...
let ListStyleType = /*#__PURE__*/function (ListStyleType) {
...
const onKeyDownIndentList = (editor, plugin) => e => {
  ...
  if (isHotkey('Enter', e) && plateCommon.isBlockAboveEmpty(editor) && node.indent) {
    outdentList(editor);
    e.stopPropagation();
    e.preventDefault();
  }
...
const withIndentList = (editor, {
  ...
  editor.apply = operation => {
    ...
    if (nodeBefore && operation.type === 'set_node') {
      ...
      const indent = operation.newProperties[plateIndent.KEY_INDENT];
...
const someIndentList = (editor, type) => {
...
const useIndentListToolbarButtonState = ({
...
const useIndentListToolbarButton = ({
  nodeType,
  pressed
}) => {
...
exports.someIndentList = someIndentList;
...
exports.useIndentListToolbarButton = useIndentListToolbarButton;
exports.useIndentListToolbarButtonState = useIndentListToolbarButtonState;
