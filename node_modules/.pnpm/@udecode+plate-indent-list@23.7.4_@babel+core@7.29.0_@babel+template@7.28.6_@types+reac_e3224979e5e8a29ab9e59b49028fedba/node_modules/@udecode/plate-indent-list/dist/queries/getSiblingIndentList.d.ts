 ...
 */
export declare const getSiblingIndentList: <N extends EElement<V>, V extends Value = Value>(editor: TEditor<V>, [node, path]: EElementEntry<V>, { getPreviousEntry, getNextEntry, query, eqIndent, breakQuery, breakOnLowerIndent, breakOnEqIndentNeqListStyleType, }: GetSiblingIndentListOptions<N, V>) => TNodeEntry<N> | undefined;
