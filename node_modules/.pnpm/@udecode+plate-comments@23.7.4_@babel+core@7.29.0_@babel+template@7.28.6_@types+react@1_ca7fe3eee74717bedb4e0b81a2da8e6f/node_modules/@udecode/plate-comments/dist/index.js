...
function CommentsProvider({
  ...
  return /*#__PURE__*/React.createElement(plateCommon.JotaiProvider, {
...
const useCommentDeleteButtonState = () => {
...
const CommentDeleteButton = plateCommon.createPrimitiveComponent('button')({
  stateHook: useCommentDeleteButtonState,
  propsHook: useCommentDeleteButton
});

const useCommentEditCancelButton = () => {
...
const CommentEditCancelButton = plateCommon.createPrimitiveComponent('button')({
  propsHook: useCommentEditCancelButton
});

const useCommentEditSaveButtonState = () => {
...
const useCommentEditSaveButton = ({
  editingValue,
  setEditingValue,
  id,
  onCommentUpdate,
...
const CommentEditSaveButton = plateCommon.createPrimitiveComponent('button')({
...
const useCommentEditButtonState = () => {
...
const CommentEditButton = plateCommon.createPrimitiveComponent('button')({
  stateHook: useCommentEditButtonState,
  propsHook: useCommentEditButton
});

const useCommentEditTextareaState = () => {
  const setEditingValue = useCommentActions().editingValue();
...
const CommentEditTextarea = plateCommon.createPrimitiveComponent('textarea')({
  stateHook: useCommentEditTextareaState,
  propsHook: useCommentEditTextarea
});

const useCommentNewSubmitButtonState = () => {
...
const useCommentNewSubmitButton = ({
  editingCommentText,
  resetNewCommentValue,
  addComment,
  isReplyComment,
...
const CommentNewSubmitButton = plateCommon.createPrimitiveComponent('button')({
  stateHook: useCommentNewSubmitButtonState,
  propsHook: useCommentNewSubmitButton
});

const useCommentNewTextareaState = () => {
  const setNewValue = useCommentsActions().newValue();
...
const CommentNewTextarea = plateCommon.createPrimitiveComponent('textarea')({
  stateHook: useCommentNewTextareaState,
  propsHook: useCommentNewTextarea
});

const useCommentResolveButton = () => {
  const onCommentUpdate = useCommentsSelectors().onCommentUpdate();
  const activeCommentId = useCommentsSelectors().activeCommentId();
  const setActiveCommentId = useCommentsActions().activeCommentId();
...
const CommentResolveButton = plateCommon.createPrimitiveComponent('button')({
  propsHook: useCommentResolveButton
});

const useCommentUserName = () => {
  var _user$name;
...
const CommentUserName = plateCommon.createPrimitiveComponent('div')({
  propsHook: useCommentUserName
});

const useCommentsPositionerState = () => {
...
const CommentsPositioner = plateCommon.createPrimitiveComponent('div')({
  stateHook: useCommentsPositionerState,
  propsHook: useCommentsPositioner
});

const useCommentAddButton = () => {
  const addCommentMark = useAddCommentMark();
  const setFocusTextarea = useCommentsActions().focusTextarea();
  const myUserId = useCommentsSelectors().myUserId();
...
const useCommentItemContentState = () => {
  const comment = useComment();
...
const useCommentsShowResolvedButton = () => {
  const editor = plateCommon.usePlateEditorRef();
...
const useFloatingCommentsState = () => {
  ...
  React.useEffect(() => {
    ...
    if (activeCommentId && plateCommon.someNode(editor, {
      match: n => n[MARK_COMMENT]
    })) {
      setActive(true);
    }
...
exports.useCommentDeleteButtonState = useCommentDeleteButtonState;
exports.useCommentEditButton = useCommentEditButton;
exports.useCommentEditButtonState = useCommentEditButtonState;
exports.useCommentEditCancelButton = useCommentEditCancelButton;
exports.useCommentEditSaveButton = useCommentEditSaveButton;
exports.useCommentEditSaveButtonState = useCommentEditSaveButtonState;
exports.useCommentEditTextarea = useCommentEditTextarea;
exports.useCommentEditTextareaState = useCommentEditTextareaState;
exports.useCommentItemContentState = useCommentItemContentState;
exports.useCommentLeaf = useCommentLeaf;
exports.useCommentLeafState = useCommentLeafState;
exports.useCommentNewSubmitButton = useCommentNewSubmitButton;
exports.useCommentNewSubmitButtonState = useCommentNewSubmitButtonState;
exports.useCommentNewTextarea = useCommentNewTextarea;
exports.useCommentNewTextareaState = useCommentNewTextareaState;
