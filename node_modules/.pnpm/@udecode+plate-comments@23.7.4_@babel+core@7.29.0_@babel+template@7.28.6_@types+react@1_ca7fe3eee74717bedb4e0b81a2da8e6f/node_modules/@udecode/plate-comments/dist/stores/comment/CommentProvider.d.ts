...
export declare function CommentProvider({ children, scope, ...props }: Partial<CommentStoreState> & {
    children: ReactNode;
    scope?: Scope;
}): React.JSX.Element;
export declare const useCommentUser: (scope?: Scope) => CommentUser | null;
export declare const useCommentReplies: (scope?: Scope) => Record<string, TComment>;
export declare const useComment: (scope?: Scope) => TComment | null;
export declare const useCommentText: (scope?: Scope) => string | null;
