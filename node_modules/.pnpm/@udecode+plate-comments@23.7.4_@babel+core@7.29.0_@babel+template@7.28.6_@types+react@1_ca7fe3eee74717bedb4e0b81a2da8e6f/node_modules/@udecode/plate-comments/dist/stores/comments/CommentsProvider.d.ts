...
export declare function CommentsProvider({ children, ...props }: Partial<CommentsStoreState> & {
    children: ReactNode;
}): React.JSX.Element;
...
export declare const useCommentById: (id?: string | null) => TComment | null;
...
export declare const useUpdateComment: (id?: string | null) => (value: Partial<TComment>) => void;
